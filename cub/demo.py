...
if opts.adv:
    result = scipy.io.loadmat('attack_query/rerun_lr4-%d/16/query.mat'%opts.method)
...
if opts.adv:
    query_path = query_path.replace('images/test','attack_query/rerun_lr4-%d/16/'%opts.method)
print(query_path)
...
try: # Visualize Ranking Result 
    ...
    for i in range(10):
        ...
        ax.axis('off')
        img_path, _ = image_datasets['test'].imgs[index[i+1]]
